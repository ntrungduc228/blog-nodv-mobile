...
export const PostToolbar = ({children}) => {
  return (
    <View
      ...
      className="absolute px-4 left-1/2 drop-shadow-sm flex-row items-center rounded-full h-10 bottom-10 bg-white shadow-md">
      {children}
    </View>
  );
};

const Divider = () => <View className="w-[1px] mx-4 bg-slate-300 h-[80%]" />;
