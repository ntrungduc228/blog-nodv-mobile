...
export const ClapIcon = props => (
  <Svg
    ...
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.37.83 12 3.28l.63-2.45h-1.26zm4.05 1.01-1.18-.39-.34 2.5 1.52-2.1zm-5.66-.39-1.19.4 1.53 2.1-.34-2.5zm10.49 10.39-2.5-4.4a1.42 1.42 0 0 0-.93-.64.96.96 0 0 0-.75.18c-.25.19-.4.42-.45.7l.05.05 2.35 4.13c1.62 2.95 1.1 5.78-1.52 8.4l-.46.41c1-.13 1.93-.6 2.78-1.45 2.7-2.7 2.51-5.59 1.43-7.38zm-8.18-2.83c-.13-.69.08-1.3.57-1.77l-2.06-2.07a1.12 1.12 0 0 0-1.56 0c-.15.15-.22.34-.27.53L12.07 9z"
    />
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
